/* _____________ LV1 추억 점수 _____________ */
...
/*
  ** 문제 설명 **
  ...
  각각 [11점, 1점, 55점]]이고, "tony"는 그리움 점수가 없을 때, 이 사진의 추억 점수는 3명의 그리움 점수를 
  합한 67(11 + 1 + 55)점입니다.
  ...
  ** 제한 사항 **
  ...
  - 3 ≤ name의 길이 = yearning의 길이≤ 100
    ㄴ 3 ≤ name의 원소의 길이 ≤ 7
    ㄴ name의 원소들은 알파벳 소문자로만 이루어져 있습니다.
    ㄴ name에는 중복된 값이 들어가지 않습니다.
    ㄴ 1 ≤ yearning[i] ≤ 100
    ㄴ yearning[i]는 i번째 사람의 그리움 점수입니다.
  - 3 ≤ photo의 길이 ≤ 100
    ㄴ 1 ≤ photo[i]의 길이 ≤ 100
    ㄴ 3 ≤ photo[i]의 원소(문자열)의 길이 ≤ 7
    ㄴ photo[i]의 원소들은 알파벳 소문자로만 이루어져 있습니다.
    ㄴ photo[i]의 원소들은 중복된 값이 들어가지 않습니다.
