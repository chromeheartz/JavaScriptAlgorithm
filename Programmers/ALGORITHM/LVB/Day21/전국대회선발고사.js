/* _____________ LVB 전국 대회 선발 고사 _____________ */
...
/*
  ** 문제 설명 **
  ...
  담긴 boolean 배열 attendance가 매개변수로 주어집니다. 전국 대회에 선발된 학생 번호들을 
  ...
  ** 제한 사항 **
  ...
  - attendance[i]는 i번 학생의 전국 대회 참석 가능 여부를 나타냅니다.
    ㄴ attendance[i]가 true라면 참석 가능, false면 참석 불가능을 의미합니다.
  ...
  ** 입출력 예 **
  ...
  - 입출력 예 #3
    ...
    다음으로 4, 5, 6등은 각각 5번, 2번, 0번 학생이고 세 학생 모두 전국 대회에 참석 가능하므로 각각 
    1순위, 2순위, 3순위로 선발됩니다. 따라서 10000 × 5 + 100 × 2 + 0 = 50200을 return 합니다.
*/

function solution(rank, attendance) {
  let filteredArr = rank.filter((_, i) => attendance[i] === true)
  let [a, b, c] = filteredArr.sort((x, y) => x - y)
  a = rank.indexOf(a)
  b = rank.indexOf(b)
  c = rank.indexOf(c)
  return (10000 * a) + (100 * b) + (1 * c)
}