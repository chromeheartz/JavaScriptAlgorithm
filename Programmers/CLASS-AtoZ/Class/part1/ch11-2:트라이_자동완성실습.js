...
/*
  ...
  * 출력형식 *
  ...
  세 번째 예제는 총 15 자를 입력해야 하고 설명은 아래와 같다.
    ㄴ word는 word모두 입력해야 한다.
    ㄴ war는 war 까지 모두 입력해야 한다.
    ㄴ warrior는 warr 까지만 입력하면 된다.
    ㄴ world는 worl까지 입력해야 한다. (word와 구분되어야 함을 명심하자)

  문제 링크 : https://school.programmers.co.kr/learn/courses/13213/lessons/91089
*/
